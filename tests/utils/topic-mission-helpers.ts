...
// Local dev service_role key — env override with committed local-dev default.
// Falls back to the well-known Supabase CLI default JWT so local test runs
// work without explicit env configuration.
