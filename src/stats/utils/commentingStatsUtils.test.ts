...
import { getTotalCommentCount, sortCommentingStats } from './commentingStatsUtils';
...
describe('commentingStatsUtils', () => {
  ...
  describe('sortCommentingStats', () => {
    ...
    it('should handle null counts in sorting', () => {
      ...
      // Users with 0 comments should come after
    });
    ...
    it('should handle current user not in list', () => {
      ...
      // Should sort by count since current user is not in list
    ...
    it('should handle users with equal comment counts', () => {
      ...
      // All have same count, relative order should be stable
