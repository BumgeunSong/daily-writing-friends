        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-background">
                ...
                <main className="container flex flex-col items-center justify-center py-8">
                    ...
                    <p className="text-muted-foreground">We couldn't load the data. Please try again later.</p>
                </main>
            </div>
        )
    }
                ...
                <ScrollArea className="h-[calc(100vh-12rem)]">
                    <div className="space-y-4 pb-20">
                        {writingStats ? (
                            ...
                            <p className="text-center text-muted-foreground">No writing stats available.</p>
                        )}
                    </div>
                </ScrollArea>
            </main>
