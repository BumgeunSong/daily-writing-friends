  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-background py-3">
        <div className="container mx-auto flex items-center justify-between px-3 md:px-4">
          <div className="flex min-h-[44px] items-center space-x-2 rounded-lg p-2">
            <Settings className="size-4 text-foreground md:size-5" />
            <span className="text-xl font-semibold tracking-tight text-foreground md:text-2xl">알림 설정</span>
          </div>
          <Link 
            to="/notifications" 
      ...
      <main className="container mx-auto px-3 py-2 md:px-4">
        <div className="reading-shadow overflow-hidden rounded-lg border border-border/50 bg-card">
