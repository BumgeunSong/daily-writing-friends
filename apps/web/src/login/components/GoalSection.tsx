    ...
    <div className='space-y-8'>
      ...
      <Card className='border-none bg-muted/10'>
        ...
        <CardContent className='space-y-4'>
          ...
          <p className='text-muted-foreground'>우리는 주 5회 꾸준히 쓰는 습관을 만듭니다.</p>
          <p className='text-muted-foreground'>
      ...
      <Card className='border-none bg-muted/10'>
        ...
        <CardContent className='space-y-4'>
          ...
          <p className='text-muted-foreground'>그렇다고 너무 공개적이면 솔직하게 쓰기 어렵죠.</p>
          <p className='text-muted-foreground'>
      ...
      <Card className='border-none bg-muted/10'>
        ...
        <CardContent className='space-y-4'>
          ...
          <p className='text-muted-foreground'>뭐라도 쓰려다 보면 할 말이 생깁니다.</p>
          <p className='text-muted-foreground'>
