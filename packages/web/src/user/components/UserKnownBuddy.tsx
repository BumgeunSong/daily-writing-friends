...
export function UserKnownBuddy() {
    ...
    return (
        <div className="mt-6 flex items-center gap-3 rounded-xl bg-gradient-to-tr from-orange-100 via-pink-100 to-purple-100 px-4 py-2">
            <span className="text-sm font-semibold text-gray-700">비밀 친구</span>
            <Link to={`/user/${knownBuddy.uid}`} className="group flex items-center gap-2">
